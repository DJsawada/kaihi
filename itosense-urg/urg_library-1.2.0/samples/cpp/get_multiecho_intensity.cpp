...
namespace{
	void print_echo_data(const vector<long>& data, const vector<unsigned short> intensity, int index, int max_echo_size){// [mm]
	...
	void print_data(const Urg_driver& urg, const vector<long>& data, const vector<unsigned short>& intensity, long time_stamp){
		#if 1
